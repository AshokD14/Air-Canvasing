...
colors = [(255, 0, 0), (0, 255, 0), (0, 0, 255), (211, 0, 148)]
...
paintWindow = cv2.rectangle(paintWindow, (505, 1), (600, 65), (211, 0, 148), 2)  # Yellow button
...
while ret:
    ...
    frame = cv2.rectangle(frame, (505, 1), (600, 65), (211, 0, 148), 2)
